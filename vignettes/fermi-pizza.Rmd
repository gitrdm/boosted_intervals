...
# Geometric mean of the bounds (typical area value)
bounds_km2 <- c(lower_bounds(total_area_km2), upper_bounds(total_area_km2))
geom_mean_area <- sqrt(bounds_km2[1] * bounds_km2[2])

print("Geometric mean of area bounds (typical area):")
print(geom_mean_area)
```
