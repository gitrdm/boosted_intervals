...
angles <- units_interval(0, pi / 6, unit = "1")
sin(angles)
cos(angles)
...
Exponentials, logarithms, and trigonometric functions all require
dimensionless intervals. Attempting to apply them to intervals carrying
physical units will raise an error, helping catch inconsistent analyses
early.
